  ...
  return (
    <div className="grid grid-cols-4 gap-4">
      <div className="bg-[#111118] rounded-xl border border-white/10 p-4">
        ...
        <p className="text-2xl font-medium text-white">{fmt(totalStars)}</p>
      ...
      <div className="bg-[#111118] rounded-xl border border-white/10 p-4">
        ...
        <p className="text-2xl font-medium text-white">{newReleases}</p>
        <p className="text-xs mt-1 text-gray-600">since last check</p>
      </div>
      <div className="bg-[#111118] rounded-xl border border-white/10 p-4">
        <p className="text-xs text-gray-500 mb-1">News articles</p>
        <p className="text-2xl font-medium text-white">{newsItems}</p>
        <p className="text-xs mt-1 text-gray-600">since last check</p>
      </div>
      <div className="bg-[#111118] rounded-xl border border-white/10 p-4">
        <p className="text-xs text-gray-500 mb-1">Tracked repos</p>
        <p className="text-2xl font-medium text-white">{trackedRepos}</p>
        <p className="text-xs mt-1 text-gray-600">{daysTracked} days of data</p>
      </div>
    </div>
  )
}
